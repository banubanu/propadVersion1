...
@Entity
@Table(name = "mediclaim_form")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class MediclaimForm {
	...
	public String toString() {
		return "MediclaimForm [mc_id=" + mc_id + ", ie_id=" + ie_id + ", mc_spouse_name=" + mc_spouse_name
				+ ", mc_spouse_dob=" + mc_spouse_dob + ", mc_child1_name=" + mc_child1_name + ", mc_child1_dob="
				+ mc_child1_dob + ", mc_child1_sex=" + mc_child1_sex + ", mc_child2_name=" + mc_child2_name
				+ ", mc_child2_dob=" + mc_child2_dob + ", mc_child2_sex=" + mc_child2_sex + ", mc_father_name="
				+ mc_father_name + ", mc_father_dob=" + mc_father_dob + ", mc_mother_name=" + mc_mother_name
				+ ", mc_mother_dob=" + mc_mother_dob + "]";
	}
